...
/**
 * UI flow helpers shared by both e2e suites (apps/demo-e2e, apps/native-electron-e2e).
...
export async function openAssistantWithConversation(page: Page, conversationId: string) {
  ...
  // relative gotos need a `baseURL` (demo sets one, the Electron context does not).
