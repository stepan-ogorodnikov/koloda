...
| Change persistence / restore | docs/specs/ASSISTANT-CHAT-CONVERSATIONS.md (§Persistence) | libs/srs-react/src/lib/assistant/use-conversation-persistence.ts, create-save-scheduler.ts, conversation-persistence.ts (coerce/normalize/cancelStreaming); drizzle/, crates/koloda-core/src/repo | Failed runs must not break conversation persistence. |
