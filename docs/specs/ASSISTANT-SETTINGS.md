...
Covers assistant settings: the chat prompt template, live preview, temperature, and how saved values apply to later runs.
...
- **Compiled prompt** — the template after trim. Preview and run share this compile.
...
Nothing about the user's decks is baked into the compiled prompt.
