...
- [ ] 1. Type the native addon boundary and add the contract lib
...
- [ ] 2. Register data IPC handlers from a typed table
...
- [ ] 3. Type the renderer bridge from the contract and dedupe the AI channel
